...
function setup(instrumentationKey) {
    ...
    if (exports.defaultClient && exports.defaultClient.channel) {
        exports.defaultClient.channel.setUseDiskRetryCaching(_isDiskRetry);
    }
...
var Configuration = (function () {
     ...
     */
    Configuration.setAutoCollectConsole = function (value) {
        _isConsole = value;
        if (_isStarted) {
     ...
     * @returns {Configuration} this class
     */
    Configuration.setUseDiskRetryCaching = function (value, resendInterval) {
        _isDiskRetry = value;
        if (exports.defaultClient && exports.defaultClient.channel) {
            exports.defaultClient.channel.setUseDiskRetryCaching(value, resendInterval);
        }
        return Configuration;
    };
    /**
